...
var Dajaxice = {
    ...
    dash: function(callback_function, argv, custom_settings){
    ...
    event_regns: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mailer.event_regns', 'POST', callback_function, argv, custom_settings);
    },

    core_approve_email: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mailer.core_approve_email', 'POST', callback_function, argv, custom_settings);
    },

    send_email: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mailer.send_email', 'POST', callback_function, argv, custom_settings);
    },

    send_individual_mail: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mailer.send_individual_mail', 'POST', callback_function, argv, custom_settings);
    },

    approval_list: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mailer.approval_list', 'POST', callback_function, argv, custom_settings);
    },

    mail_events: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mailer.mail_events', 'POST', callback_function, argv, custom_settings);
    },
