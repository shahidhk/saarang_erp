...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('task_task', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_created', to=orm['auth.User'])),
            ('origin_dept', self.gf('django.db.models.fields.related.ForeignKey')(related_name='task_originating_dept', to=orm['erp.Department'])),
            ('destin_dept', self.gf('django.db.models.fields.related.ForeignKey')(related_name='task_destination_dept', to=orm['erp.Department'])),
            ...
            ('time_origin_core_approval', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 4, 0, 0), auto_now=True, blank=True)),
            ('origin_core_comment', self.gf('django.db.models.fields.CharField')(default='No comment', max_length=200)),
            ('origin_core_deadline', self.gf('django.db.models.fields.DateField')(default='2013-08-04')),
            ...
            ('time_destin_core_approval', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 4, 0, 0), auto_now=True, blank=True)),
            ('destin_core_comment', self.gf('django.db.models.fields.CharField')(default='No comment', max_length=200)),
            ('destin_core_deadline', self.gf('django.db.models.fields.DateField')(default='2013-08-04')),
            ...
            ('time_destn_coord_acknowledged', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 4, 0, 0), auto_now=True, blank=True)),
    ...
    models = {
        ...
        'task.task': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_created'", 'to': "orm['auth.User']"}),
            ...
            'destin_core_deadline': ('django.db.models.fields.DateField', [], {'default': "'2013-08-04'"}),
            'destin_core_priority': ('django.db.models.fields.FloatField', [], {'default': '4.5'}),
            'destin_dept': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'task_destination_dept'", 'to': "orm['erp.Department']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'origin_core_deadline': ('django.db.models.fields.DateField', [], {'default': "'2013-08-04'"}),
            'origin_core_priority': ('django.db.models.fields.FloatField', [], {'default': '4.5'}),
            'origin_deadline': ('django.db.models.fields.DateField', [], {}),
            'origin_dept': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'task_originating_dept'", 'to': "orm['erp.Department']"}),
            ...
            'time_destin_core_approval': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 4, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'time_destn_coord_acknowledged': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 4, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'time_origin_core_approval': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 4, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
