...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('userprofile_userprofile', (
            ...
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user_event', null=True, to=orm['erp.Event'])),
    ...
    models = {
        ...
        'userprofile.userprofile': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'user_event'", 'null': 'True', 'to': "orm['erp.Event']"}),
