...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('userprofile_userprofile', (
            ...
            ('saarang_email', self.gf('django.db.models.fields.EmailField')(max_length=100, null=True, blank=True)),
            ...
            ('sub_dept', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user_sub_department', null=True, to=orm['erp.SubDepartment'])),
    ...
    models = {
        ...
        'userprofile.userprofile': {
            ...
            'saarang_email': ('django.db.models.fields.EmailField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'sub_dept': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'user_sub_department'", 'null': 'True', 'to': "orm['erp.SubDepartment']"}),
